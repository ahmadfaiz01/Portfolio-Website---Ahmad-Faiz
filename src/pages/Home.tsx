...
const backgroundLabels = [
  ...
  { text: 'Multimodel', section: 'about', x: '60%', y: '91%', rotate: 6, size: 'text-3xl' },
  { text: 'aI', section: 'about', x: '62%', y: '95%', rotate: 6, size: 'text-4xl' },
]
      ...
      <div className="max-w-5xl mx-auto px-6 py-10 relative z-10 pt-24">
        ...
        <div className="flex flex-col items-center text-center space-y-8 mb-16">
          ...
          <p className="text-lg sm:text-xl text-charcoal/80 max-w-2xl leading-relaxed font-body">
            CS undergrad @ NUST. Building RAG apps, evaluating LLM workflows, and shaping clear, minimal product experiences.
          </p>
          <div className="flex gap-4 justify-center items-center">
            ...
            <a
              className="rounded-full border border-charcoal/20 bg-white px-6 py-3 font-semibold text-charcoal transition hover:-translate-y-0.5 hover:shadow-lg font-body"
              href="/CV.pdf"
              target="_blank"
              rel="noreferrer"
            >
        ...
        <div className="mt-0 rounded-3xl border-2 border-[#800000]/30 bg-white p-6 shadow-sm pt-16">
          <div className="space-y-6 text-center max-w-3xl mx-auto">
            <p className="text-lg leading-relaxed font-body">
              I design and build AI products that balance performance with clarity. Current focus: RAG quality, fast
              delivery, and interfaces that earn trust.
            </p>
              ...
              {[
                ...
                >
                  <img
                    src={tech.icon}
                    alt={tech.name}
                    className="w-6 h-6 object-contain group-hover:brightness-0 group-hover:invert transition"
                  />
                </motion.div>
              ))}
            </div>
