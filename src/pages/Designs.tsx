...
const designShots: DesignShot[] = [
  ...
  },
  {
    ...
    images: ['/optimized/nust-fest-1.webp', '/optimized/nust-fest-2.webp'],
    photoshopLink: '#',
    shadowStyle: 'maroon',
  },
  {
    ...
    category: 'Graphic Design',
    images: ['/optimized/sketch-1.webp', '/optimized/sketch-2.webp', '/optimized/sketch-3.webp'],
    photoshopLink: '#',
    shadowStyle: 'black',
  },
  {
    ...
    category: 'Graphic Design',
    images: ['/optimized/poster-1.webp', '/optimized/poster-2.webp', '/optimized/poster-3.webp'],
    photoshopLink: '#',
    shadowStyle: 'maroon',
  },
  {
    ...
    category: 'Graphic Design',
    images: ['/optimized/thumbnail-1.webp', '/optimized/thumbnail-2.webp', '/optimized/thumbnail-3.webp'],
    photoshopLink: '#',
    shadowStyle: 'black',
  },
  {
    ...
    category: 'Graphic Design',
    images: ['/optimized/xpl1.webp', '/optimized/xpl2.webp'],
    photoshopLink: '#',
    shadowStyle: 'black',
  },
  {
    ...
    category: 'Graphic Design',
    images: ['/optimized/magazine cover.webp'],
    photoshopLink: '#',
    shadowStyle: 'maroon',
  },
  {
    ...
    category: 'Graphic Design',
    images: ['/optimized/ad-1.webp', '/optimized/ad-2.webp'],
    photoshopLink: '#',
    shadowStyle: 'maroon',
  },
]
