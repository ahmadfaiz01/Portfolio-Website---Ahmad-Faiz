...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  const showHamburger = isScrolled || isMobile
                      ...
                      {navItems.map((item) => {
                        ...
                        return (
                          <Link
                            ...
                            className={`px-4 py-2 rounded-full text-sm font-semibold transition-all duration-300 whitespace-nowrap flex items-center justify-center ${isActive
